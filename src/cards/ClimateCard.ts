...
import { MushroomClimateCardConfig } from '../types/lovelace/cards/mushroom/climate-card-config';
...
class ClimateCard extends AbstractCard {
  ...
  static getDefaultConfig(): MushroomClimateCardConfig {
    return {
   ...
   */
  constructor(entity: EntityRegistryEntry, customConfiguration?: MushroomClimateCardConfig) {
    super(entity);

...
import { MushroomLockCardConfig } from '../types/lovelace/cards/mushroom/lock-card-config';
...
class LockCard extends AbstractCard {
  ...
  static getDefaultConfig(): MushroomLockCardConfig {
    return {
   ...
   */
  constructor(entity: EntityRegistryEntry, customConfiguration?: MushroomLockCardConfig) {
    super(entity);
